...
func main(){
	//loop through the exectuion function 10 times
	fmt.Println("Execute Rickky bloat... FS")
	for i:=0 ; i<= 10; i++{
		if i <= 10{
			fmt.Printf("Running iteration number (%d)", i)
			execute()
		}
	}
...
//func to open your default browser
...
//executes and loops through data we want to open in browser
func execute(){
